...
export const Board = () => {
    ...
    return (
      <div className="flex flex-col w-full h-full gap-3 p-4 md:flex-row md:p-12">
        <Column
          title="Tareas"
          column="todo"
    ...
    return (
      <div className="flex flex-col w-full md:w-56 shrink-0">
        ...
        <div
          ...
          className={`flex flex-col h-full w-full transition-colors ${
  ...
  const DEFAULT_CARDS = [
    // TODO
    {
      title: "Falta de extintores - Urgente",
      id: "5",
      column: "todo",
    },
    {
      title: "Inspección de maquinaria - Alta prioridad",
      id: "6",
      column: "todo",
    },
    {
    ...
    {
      title: "Instalación de nuevas alarmas",
      id: "9",
      column: "done",
    },
    {
      title: "Revisión de sistemas de evacuación",
      id: "10",
      column: "done",
    },
  ];